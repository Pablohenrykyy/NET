...
sleep 5
cd /bin || exit
wget https://raw.githubusercontent.com/Pablohenrykyy/NET/main/Modulos/initcheck > /dev/null 2>&1
wget https://raw.githubusercontent.com/Pablohenrykyy/NET/main/Modulos/userscheck > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/Pablohenrykyy/NET/main/Modulos/checkuser.py > /dev/null 2>&1
...
echo ""
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@hpnetpro\033[0m"
